...
elseif (CMAKE_CXX_COMPILER_ID MATCHES Clang)
    ...
    set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} -Ofast -funroll-loops -fmerge-all-constants -mbmi -mlzcnt -mmovbe -mtune=znver1")

    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wall -fexceptions -fno-rtti -Wno-missing-braces")
    set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -Ofast -funroll-loops -fmerge-all-constants -mbmi -mlzcnt -mmovbe -mtune=znver1")
